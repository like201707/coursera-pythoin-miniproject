...
class Ship:
    ...
    def shoot(self):
        global a_missile
        a = angle_to_vector(my_ship.angle)
        missile_pos = [self.pos[0]+self.radius*a[0],self.pos[1]+self.radius*a[1]]
        missile_vel = [self.vel[0], self.vel[1]]
        missile_vel[0] = self.vel[0] + a[0] * 5
        missile_vel[1] = self.vel[1] + a[1] * 5
...
class Sprite:
    ...
    def update(self):
#        self.vel[0] = (random.randrange(0,5))/10.0
#        self.vel[1] = (random.randrange(0,5))/10.0
        self.pos[0] += self.vel[0]
        self.pos[1] += self.vel[1]
        self.angle += self.angle_vel
        if self.pos[0] < 0:
...
def rock_spawner():
    global a_rock
    Rock_pos = [random.randrange(0,WIDTH), HEIGHT/random.randrange(0,HEIGHT)]
    Rock_vel = [random.randrange(0,3),random.randrange(0,3)]
    Rock_ang_vel = random.randrange(0,5)/10.0
